...
def train_heritage_model():
    ...
    train_rows = []
    # 최근 데이터를 바탕으로 재질/환경별 위험 가중치 학습 데이터 생성
...
try:
    asos_params = {"serviceKey": SERVICE_KEY, "pageNo": "1", "numOfRows": "1", "dataType": "JSON", "dataCd": "ASOS", "dateCd": "HR", "startDt": base_date, "startHh": base_hour, "endDt": base_date, "endHh": base_hour, "stnIds": "281"}
...
with left:
    ...
    <div style="{card_style}; position:relative;">
        ...
        <div style="{time_style}">⏱ 측정 시각 : {tm}</div>
...
with right:
    ...
    <div style="{card_style}; position:relative;">
        ...
        <div style="margin-top:20px;">
            ...
            <div style="{label_style}">⚠ 고위험 문화재</div>
...
# 판정 결과 통계 카드 섹션
# ============================================
st.markdown('<h3 style="font-size:22px; margin-bottom:15px;">📊 AI 위험도 판정 요약</h3>', unsafe_allow_html=True)
